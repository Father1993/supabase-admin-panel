...
export function CategorySearch({ onSelectCategory, selectedCategory, searchCategories }: Props) {
            ...
            {selectedCategory ? (
                <div className="flex items-center gap-2 p-3 bg-blue-50 border border-blue-200 rounded-lg">
                    <span className="text-sm text-blue-800">
                        Выбрана категория: <strong>{selectedCategory.header || "Без названия"}</strong> (ID: {selectedCategory.id})
                    </span>
                    <button
                            ...
                            {suggestions.map((category) => (
                                ...
                                >
                                    ...
                                    <div className="text-sm text-gray-500">
                                        ...
                                        {category.product_count !== null && ` • Товаров: ${category.product_count}`}
                                    </div>
                                </button>
                            ))}
                        </div>
