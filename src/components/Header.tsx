        ...
        <div className='flex flex-col md:flex-row md:items-center md:justify-between gap-4'>
          <div className='flex justify-between items-center'>
            <div>
              ...
              <p className='text-slate-600 mt-1 text-sm sm:text-sm'>
                {subtitle}
              </p>
            </div>
            <button
          ...
          >
            ...
            >
              <Link
                href='/admin'
                className='block px-4 py-2 text-sm text-slate-700 hover:bg-slate-50 rounded-lg mx-1'
              >
