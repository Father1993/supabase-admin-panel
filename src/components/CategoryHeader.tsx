...
export function CategoryHeader({ category, size = "default", additionalBadges = [] }: Props) {
    const sizeClasses = size === "large" 
        ? "px-6 py-5" 
        : "px-5 py-4"
    
    return (
        <div className={`bg-gradient-to-r from-slate-50 to-blue-50 border-b border-slate-200 ${sizeClasses}`}>
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
                <div className="space-y-1">
                    ...
                    <div className="flex flex-wrap items-center gap-2 text-sm text-slate-600">
                        ...
                        {category.product_count !== null && category.product_count !== undefined && (
                            <>
                                <span className="text-slate-400">•</span>
