      ...
      <div className='w-full max-w-4xl bg-white text-slate-800 rounded-xl shadow-2xl border border-slate-200 overflow-hidden'>
        <div className='px-4 py-3 border-b border-slate-200 flex items-center justify-between bg-slate-50'>
          ...
          <div className='flex gap-2'>
            <button
              className='px-3 py-2 text-sm bg-white text-slate-700 border border-slate-300 rounded-lg hover:bg-slate-50'
              onClick={onCancel}
            >
              Отмена
            </button>
        ...
        <div className='p-4 space-y-4'>
          ...
          <p className='text-xs text-slate-500'>
            Совет: выделите текст и используйте кнопки сверху для
            форматирования. HTML будет очищен автоматически при сохранении.
          </p>
        </div>
      </div>
    </div>
